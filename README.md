...
| **Bench a pre-built alpha zoo** | One-line IC + alive/reversed/dead categorisation across 501 alphas (Qlib 158 + Kakushadze 101 + GTJA 191 + academic + PIT-safe fundamental + crypto) on your universe. |
...
<details>
<summary><b>Alpha Zoo</b> <sub>501 pre-built quant alphas across 7 families</sub></summary>

- 🧬 501 cross-sectional alphas, lookahead-banned at the operator layer
...
vibe-trading alpha list    # browse 501 pre-built alphas; show / bench / compare / export-manifest sub-commands available
...
│   │   │
│   │   ├── factors/                # Alpha Zoo — 501 alphas across 7 families
...
| **Alpha Zoo** | 501 pre-built alphas (Qlib 158 + Kakushadze 101 + GTJA 191 + academic + fundamental + crypto) with one-line bench, agent integration, and Web UI | **Shipped 0.1.8**, extended through 0.1.12 |
