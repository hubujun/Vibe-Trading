...
| **bench ألفا zoo جاهزة** | تشغيل IC + IR + تصنيف alive/reversed/dead عبر 485 ألفا (Qlib 158 + Kakushadze 101 + GTJA 191 + academic + PIT-safe fundamental + crypto) بسطر أوامر واحد على universe الخاص بك. |
...
<details>
<summary><b>Alpha Zoo</b> <sub>485 ألفا كمّي جاهز عبر 7 families</sub></summary>

- 🧬 485 ألفا cross-sectional، مع منع lookahead على طبقة العوامل (operators)
...
vibe-trading alpha list    # استعرض 485 ألفا جاهز؛ متاح show / bench / compare / export-manifest
...
│   │   │
│   │   ├── factors/                # Alpha Zoo — 485 ألفا عبر 7 families
...
| **Alpha Zoo** | 485 ألفا كمّي جاهز (Qlib 158 + Kakushadze 101 + GTJA 191 + academic + fundamental + crypto)، سطر أوامر واحد للـ bench، تكامل agent، وواجهة Web | **تم الإطلاق 0.1.8**، موسّع حتى 0.1.12 |
