...
| **사전 빌드된 alpha zoo 벤치** | 485개의 alpha 인자(Qlib 158 + Kakushadze 101 + GTJA 191 + academic + PIT-safe fundamental + crypto)에 대해  한 줄 CLI로 IC + IR + alive/reversed/dead 분류 수행 |
...
<details>
<summary><b>Alpha Zoo</b> <sub>7개 패밀리에 걸친 485개 사전 빌 드된 quant alpha</sub></summary>

- 🧬 operator 계층에서 lookahead가 금지된 485개 cross-sectional alpha
...
vibe-trading alpha list    # 사전 빌드된 485개 alpha 탐색; show / bench / compare / export-manifest 서브커맨드 사용 가능
...
│   │   │
│   │   ├── factors/                # Alpha Zoo — 7개 패밀리에 걸친 485개 alpha
...
| **Alpha Zoo** | 7개 패밀리에 걸친 485개의 사전 빌드된 alpha 인자(Qlib 158 + Kakushadze 101 + GTJA 191 + academic + fundamental + crypto), 한 줄 CLI 벤치, agent 통합, Web UI | **0.1.8 출시 완료**, 0.1.12까지 확장 |
